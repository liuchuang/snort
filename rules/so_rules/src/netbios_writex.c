...
int process_command (char *data, int size, u_int8_t command, int offset)
{
    ANDX_HEADER *andx;
    int ret = 0;
    u_int16_t next_command_offset;
...
int ruleWriteXeval(void *p) {
    int ret = 0;
    const u_int8_t *cursor = 0, *beg_of_payload = 0, *end_of_payload = 0;
