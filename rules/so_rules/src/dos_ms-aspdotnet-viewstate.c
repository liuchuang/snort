...
{
    (u_int8_t *) "__VIEWSTATE=", /* pattern (now in snort content format) */
    0, /* depth */
    0, /* offset */
...
Rule rule15959 = {
   ...
   { 
       ...
       "DOS Microsoft ASP.NET viewstate DoS attempt",     /* message */
...
int rule15959eval(void *p) {    
    ...
    u_int8_t decodedbuf[1024];
    u_int32_t i, decodedbytes;
