...
{
    (u_int8_t *)"CRAM-MD5",                 /* pattern to search for */
    8,                      /* depth */
    0,                      /* offset */
...
Rule ruleOPENLDAP_BIND_DOS = {
   ...
   { 
       ...
       4, /* revision c109ff0a-9630-4d2c-9da4-a3b557ea698e */
   
       "denial-of-service", /* classification, generic */
       0,  /* hardcoded priority XXX NOT PROVIDED BY GRAMMAR YET! */
       "DOS openldap server bind request denial of service attempt",     /* message */
