...
{
    (u_int8_t *) "|05 00 02|", /* pattern (now in snort content format) */
    3, /* depth */
    51, /* offset */
...
{
    (u_int8_t *) "|01 00 00 00 01 00 00 00|", /* pattern (now in snort content format) */
    8, /* depth */
    21, /* offset */
...
int rule20275eval(void *p) {
    const u_int8_t *cursor_normal = 0, *end_of_payload = 0, *beg_of_payload = 0;
    SFSnortPacket *sp = (SFSnortPacket *) p;
    u_int32_t arrays = 0, array_ctr = 0, data_size = 0;
    u_int8_t check_array[NUM_ARRAYS];
    int j;
    const u_int8_t *tmp_ptr;
